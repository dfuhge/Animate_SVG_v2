...
from src.postprocessing_old.get_svg_size_pos import get_midpoint_of_path_bbox, get_begin_values_by_starting_pos
from src.postprocessing_old.transform_animation_predictor_output import transform_animation_predictor_output
